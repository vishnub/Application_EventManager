 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Application_Stdlib_CallbackHandler
{
    /**
    ...
    protected function registerCallback($callback)
    {
        ...
        if (!$callable || $this->error) {
            ...
            throw new Application_Stdlib_Exception_InvalidCallbackException('Invalid callback provided; not callable');
        }
     ...
     * @return true
     * @throws Application_Stdlib_Exception_InvalidCallbackException if invalid
     */
    protected function validateStringCallbackFor54($callback)
    {
        ...
        if (!class_exists($class)) {
            require_once 'Application/Stdlib/Exception/InvalidCallbackException.php';
            throw new Application_Stdlib_Exception_InvalidCallbackException(sprintf(
