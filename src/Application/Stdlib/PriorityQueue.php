 ...
 *
 * @category   Zend
 * @package    Application_Stdlib
 * @copyright  Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */

require_once 'Application/Stdlib/SplPriorityQueue.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Application_Stdlib_PriorityQueue implements Countable, IteratorAggregate, Serializable
{
     ...
     * @var string
     */
    protected $queueClass = 'Application_Stdlib_SplPriorityQueue';
    ...
    /**
     * Unserialize a string into a Application_Stdlib_PriorityQueue object
     *
     * Serialization format is compatible with {@link Application_Stdlib_SplPriorityQueue}
     * 
     * @param  string $data 
     * @return void
     */
     ...
     * 
     * @return Application_Stdlib_SplPriorityQueue
     */
        ...
        if (null === $this->queue) {
            ...
            if (!$this->queue instanceof SplPriorityQueue) {
                throw new DomainException(sprintf(
                    'Application_Stdlib_PriorityQueue expects an internal queue of type SplPriorityQueue; received "%s"',
