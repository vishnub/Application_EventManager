 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Application_EventManager_SharedEventManager implements Application_EventManager_SharedEventCollection
{
    /**
    ...
    public function attach($id, $event, $callback, $priority = 1)
    {
        ...
        foreach ($ids as $id) {
            if (!array_key_exists($id, $this->identifiers)) {
                $this->identifiers[$id] = new Application_EventManager_EventManager();
            }
     ...
     */
    public function detach($id, Application_Stdlib_CallbackHandler $listener)
    {
        if (!array_key_exists($id, $this->identifiers)) {
            return false;
        }
     ...
     * @return false|Application_Stdlib_PriorityQueue
     */
