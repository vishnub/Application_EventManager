 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Application_EventManager_GlobalEventManager
{
    /**
     * @var Application_EventManager_EventCollection
     */
     ...
     * 
     * @param  null|Application_EventManager_EventCollection $events 
     * @return void
     */
    public static function setEventCollection(Application_EventManager_EventCollection $events = null)
    {
        self::$events = $events;
    }
    ...
    {
        if (null === self::$events) {
            self::setEventCollection(new Application_EventManager_EventManager());
        }
        return self::$events;
    }
     ...
     * @return Application_EventManager_ResponseCollection
     */
     ...
     * @param  callback $callback 
     * @param  int $priority 
     * @return Application_Stdlib_CallbackHandler
     */
     ...
     * 
     * @param  Application_Stdlib_CallbackHandler $listener 
     * @return bool
     */
    public static function detach(Application_Stdlib_CallbackHandler $listener)
    {
     ...
     * 
     * @param  string $event 
     * @return Application_Stdlib_PriorityQueue|array
     */
