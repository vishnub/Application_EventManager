 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
interface Application_EventManager_ListenerAggregate
{
    /**
     ...
     *
     * @param Application_EventManager_EventCollection $events
     * @param null|int $priority Optional priority "hint" to use when attaching listeners
     */
    public function attach(Application_EventManager_EventCollection $events);
