...
require_once 'Application/EventManager/EventDescription.php';
require_once 'Application/EventManager/EventManager.php';
require_once 'Application/EventManager/ResponseCollection.php';
require_once 'Application/EventManager/TestAsset/MockAggregate.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Application_EventManager_EventManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->default = '';
        $this->events  = new Application_EventManager_EventManager;
    }

    public function testAttachShouldReturnCallbackHandler()
    {
        $listener = $this->events->attach('test', array($this, __METHOD__));
        $this->assertTrue($listener instanceof Application_Stdlib_CallbackHandler);
    }
    ...
    public function testPassingArrayOfEventNamesWhenAttachingReturnsArrayOfCallbackHandlers()
    {
        ...
        foreach ($listeners as $listener) {
            $this->assertInstanceOf('Application_Stdlib_CallbackHandler', $listener);
            $this->assertSame($callback, $listener->getCallback());
        }
    }
    ...
    public function testTriggerShouldReturnAllListenerReturnValues()
    {
        ...
        $this->assertTrue($responses instanceof Application_EventManager_ResponseCollection);
    ...
    {
        $aggregate = new Application_EventManager_TestAsset_MockAggregate();
    ...
    public function testAttachAggregateReturnsAttachOfListenerAggregate()
    {
        ...
        $this->assertSame('Application_EventManager_TestAsset_MockAggregate::attach', $method);
    }
    ...
    public function testDetachAggregateReturnsDetachOfListenerAggregate()
    {
        ...
        $this->assertSame('Application_EventManager_TestAsset_MockAggregate::detach', $method);
    }
    ...
    {
        $event = new Application_EventManager_Event();
    ...
    {
        $events = new Application_EventManager_EventManager(array(__CLASS__, get_class($this)));
    ...
    public function testIdentifierGetterSettersWorkWithArrays()
    {
        ...
        $this->assertInstanceOf('Application_EventManager_EventManager', $this->events->setIdentifiers($identifiers));
        $this->assertSame($this->events->getIdentifiers(), $identifiers);
        $identifiers[] = 'baz';
        $this->assertInstanceOf('Application_EventManager_EventManager', $this->events->addIdentifiers($identifiers));
        $this->assertSame($this->events->getIdentifiers(), $identifiers);
    }
    ...
    /**
     * @group ZF-12185
     * @expectedException Application_EventManager_Exception_InvalidArgumentException
     */
    public function testInvalidArgumentExceptionCanBeThrown()
    {
        require_once "Application/EventManager/Exception/InvalidArgumentException.php";
        throw new Application_EventManager_Exception_InvalidArgumentException();
    }
    ...
    {
        return ($result instanceof Application_EventManager_EventDescription);
    }
}

if (PHPUnit_MAIN_METHOD == 'Application_EventManager_EventManagerTest::main') {
    Application_EventManager_EventManagerTest::main();
}
